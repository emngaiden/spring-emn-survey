...
public class JwtBuilderImpl implements JwtBuilder {
    ...
    private static final Base64Codec textCodec = new Base64Codec();
    private static final Base64UrlCodec urlCodec = new Base64UrlCodec(); 
    ...
    public JwtBuilder signWith(SignatureAlgorithm alg, String base64EncodedSecretKey) {
        ...
        byte[] bytes = textCodec.decode(base64EncodedSecretKey);
    ...
    public String compact() {
        ...
        if (compressionCodec != null) {
            ...
            base64UrlEncodedBody = urlCodec.encode(compressionCodec.compress(bytes));

        } else {
            base64UrlEncodedBody = this.payload != null ?
                    urlCodec.encode(this.payload) :
    ...
    protected JwtSigner createSigner(SignatureAlgorithm alg, Key key) {
        return new JwtSignerImpl(alg, key);
    }
